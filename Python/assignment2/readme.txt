...
As this program is written in python, to execute it, the user should have python installed on their system.
...
python descriptiveStatistics.pl dataFile.txt 2
Here, we write 2 as in python, indexing begins at 0.
